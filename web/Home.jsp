    ...
    <body>
        ...
        <div style="margin-top: 80px; text-align: center">
            ...
            <div class="row" style="width: 96%; margin: auto">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="text-align: left; border: solid 2px #c4de5f; margin-right: 2%; z-index: 1000;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 1vh">
                        ...
                        <div>
                            ...
                            <p>Balance: "<img src="images/isotipo-Luka-balance.png" style="max-width: 20%; min-width: 20px; margin-bottom: 1px; margin-top: 1px;" /> <span id="myBalance"><%= pl.getBalance()%></span> LUK</p>
               ...
               <div class="col-lg-5 col-md-5" style="text-align: left; border: solid 2px #c4de5f;">
                    ...
                    <div class="row"  style="color: white; text-align: center">
                        <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn-default" style="background-color: #a3b0c9; color: #fff">MANUAL BETTING</button>
                        <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn-default" style="background-color: #484d5f; color: #fff">AUTOMATED BETTING </button>
                    </div>
                    ...
                    <div style="margin-top: 2vh; margin-left: 5%; margin-right: 5%" class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" style="padding: 0">
                            <button onclick="divideButton()" class="form-control btnBets" style="background-color: #484d5f; color: #fff">/2</button>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" style="padding: 0">
                            <button onclick="doubleButton()" class="form-control btnBets" style="background-color: #484d5f; color: #fff">X2</button>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" style="padding: 0">
                            <button onclick="maxButton()" class="form-control btnBets" style="background-color: #484d5f; color: #fff">MAX</button>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 2vh; margin-bottom: 1vh; text-align: center">
                        <button id="playButton" class="btn btn-lg btn-success btn-block" style="width: 50%; margin: auto" onclick="play()"><b>ROLL!</b></button>
                    </div>
            ...
            <div class="row pull-right" style="text-align: right; margin-right: 4%; display: inline-block"  >
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <button border:solid="" class="" onclick="changeTableMyLast()" style="background-color: #484d5f; color: #fff">My last bets</button>
                    <button onclick="changeTableRecentBets()" class="" style="background-color: #484d5f; color: #fff">Recent bets</button>
                    <button onclick="changeTableHighRollers()" class="" style="background-color: #484d5f; color: #fff">High rollers</button>
                    <button onclick="" class="" style="background-color: #484d5f; color: #fff">History</button>
                </div>
            </div>
